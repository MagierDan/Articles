Dans toute équipe et particulièrement dans l'informatique, tout départ ou toute arrivée déstabilise celle-ci.
...
### La team: son Legacy et son besoin
...
### Environnement
L'environnment dans lequel va évoluer le nouveau va aussi jouer un rôle important à son intégration.
...
Intégrer le nouveau revient forcément à s'occuper de lui surtout au début. Il faut bien lui expliquer le métier,
...
### Conclusion
Comme vu précédemment, l'arrivée d'un nouveau se prépare. Il peut être fortemeent intéressant d'investir sur ce
